        ...
        <Card className="bg-card border border-border rounded-xl shadow-card">
          ...
          <CardContent className="px-4 sm:px-6 pb-6">
            <Tabs defaultValue="signin" className="w-full">
              <TabsList className="grid w-full grid-cols-2 h-12 bg-gray-100 dark:bg-gray-800 rounded-lg p-1 mb-6">
                <TabsTrigger 
                  value="signin" 
                  className="text-sm font-medium text-gray-600 dark:text-gray-400 data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-gray-900 dark:data-[state=active]:text-gray-100 data-[state=active]:shadow-sm rounded-md transition-all duration-200"
                >
                  Sign In
                </TabsTrigger>
                <TabsTrigger 
